...
import com.example.tfg_gym.Models.Usuario;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private EditText editEmail, editNombre, editApellidos, editSexo, editContraseña,editTelefono,editRepetirContraseña,
            editUbicacion,editObjetivos;
    private CircleImageView imageProfile;

    private Button botonRegistrar, botonLogin;
    private TextView botonAñadirFoto;
    private String email, nombre, apellidos, edad, contraseña,repetirContraseña, telefono, sexo, ubicacion, objetivos, stringFoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editNombre = (EditText) findViewById(R.id.sign_nombre);
        editApellidos = (EditText) findViewById(R.id.sign_apellido);
        editRepetirContraseña=(EditText)findViewById(R.id.sign_input_password_repetir);
        editSexo = (EditText) findViewById(R.id.sign_sexo);
        editContraseña = (EditText) findViewById(R.id.sign_input_password);
        editUbicacion = (EditText) findViewById(R.id.sign_ubicacion);
        editTelefono = (EditText)findViewById(R.id.sign_telefono);
        editObjetivos = (EditText)findViewById(R.id.sign_objetivos) ;
    ...
    private void registrarUsuario() {
        ...
        objetivos = editObjetivos.getText().toString();
        recordar = "false";
        ...
        mAuth.createUserWithEmailAndPassword(email, contraseña).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Usuario user = new Usuario(id, nombre, apellidos,email,contraseña,telefono,ubicacion,sexo,objetivos,stringFoto);
